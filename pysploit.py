  ...
  while (command_input==command_input):
      ...
      if command_input=="use Hax/make/dir":
          ...
          while True:
            ...
            if command_input=="return":
                    command_input==str(input('con_hax> '))
      ...
      if command_input=="use Hax/network/scan":
        while True:
            command_input1=input('con_hac/Hax/network/scan')
            
            if command_input1=="sim scan":
                scanner=nmap.PortScanner()
                begin=input('Port To Start? ')
                end=input('Port To End? ')
